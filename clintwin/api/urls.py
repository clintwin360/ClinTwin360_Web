...
router.register(r'virtualtrial_questions', views.VirtualTrialParticipantQuestionViewSet)
...
router.register(r'virtualtrial_responses', views.VirtualTrialParticipantResponseViewSet)
